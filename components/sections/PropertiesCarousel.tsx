...
const PLACEHOLDERS: Partial<Property>[] = [
  {
    id: "placeholder-1",
    ...
    description: "Palatial 3/4 BHK residences in the heart of IT City. Known for double-height ceilings and massive private decks.",
    features: ["Swimming Pool", "Gym", "Private Deck"],
    images: ["/assets/images/home/marbella-royce.avif"],
    featured: true,
  ...
  },
  {
    ...
    description: "An exclusive enclave of 180 apartments across 4.4 acres. Features a 50,000 sq. ft. Novotel-managed clubhouse.",
    features: ["Novotel Clubhouse", "VRV AC", "Low Density"],
    images: ["/assets/images/home/evoq.webp"],
    featured: true,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  }
