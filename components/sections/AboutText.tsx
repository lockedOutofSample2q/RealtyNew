        ...
        <div className="flex flex-col lg:flex-row justify-between gap-8 lg:gap-[6vw] items-start">
          ...
          <div className="w-full lg:w-[65%]">
            ...
            <motion.p
              ...
              className="text-white/70 text-[clamp(14px,1.2vw,18px)] font-light leading-relaxed max-w-full lg:max-w-[80%]"
            >
          ...
          <div className="w-full lg:w-[20%] flex lg:justify-end pt-0 lg:pt-[8vh]">
            <motion.div
