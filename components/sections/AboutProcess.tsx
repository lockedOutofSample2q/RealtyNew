        ...
        <div className="flex flex-col gap-[6vh]">
          {PROCESS.map((item, idx) => (
            <motion.div
              ...
              className="flex flex-row items-center gap-4 sm:gap-[4vw]"
            >
              <div className="text-black/10 text-[clamp(3.5rem,8vw,8rem)] font-light tracking-tighter w-[clamp(3.5rem,12vw,8rem)] shrink-0">
                {item.num}
              </div>
