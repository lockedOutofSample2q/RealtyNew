...
export function PropertiesMapContainer({ properties, leafletReady }: PropertiesMapContainerProps) {
  return (
    <div className="order-1 md:order-2 w-full md:w-[42%] h-[45vw] min-h-[260px] max-h-[380px] md:h-[120vh] md:min-h-[700px] md:sticky md:top-[-10vh] self-start shrink-0 z-0 relative">
