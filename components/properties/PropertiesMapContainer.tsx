...
export function PropertiesMapContainer({ properties, leafletReady }: PropertiesMapContainerProps) {
  return (
    <div className="order-1 md:order-2 w-full md:w-[45%] h-[50vh] md:h-[calc(96vh-var(--nav-height))] md:sticky md:top-[calc(var(--nav-height)+2vh)] self-start shrink-0 z-0 relative p-4 md:pl-0 md:pr-6">
