...
export function PropertiesMapContainer({ properties, leafletReady, onPropertyClick, hoveredId, onHover, tab }: PropertiesMapContainerProps) {
  return (
    <div className="order-1 md:order-2 w-full md:w-[45%] h-[100vh] md:h-[94vh] md:sticky md:top-[3vh] self-start shrink-0 z-0 relative p-4 md:pl-0 md:pr-6">
      {leafletReady && (
        <PropertiesMap 
