...
// Verified regional source pool
const sourcePool = {
  'Sector Intelligence': ['mohali_lux_1.jpg', 'ind_legal_2.jpg'],
  'Land Seller Series': ['punjab_land_1.jpg', 'punjab_land_2.jpg', 'punjab_land_3.jpg'],
  'Buyer Guide': ['mohali_lux_1.jpg', 'ind_legal_2.jpg'],
  'Investment Thesis': ['mohali_lux_1.jpg', 'ind_legal_2.jpg'],
  'Legal Updates': ['ind_legal_1.jpg', 'ind_legal_2.jpg'],
  'Process & Paperwork': ['ind_legal_1.jpg', 'ind_legal_2.jpg'],
  'Market Analysis': ['mohali_lux_1.jpg', 'ind_legal_1.jpg'],
  'NRI Investor Series': ['mohali_lux_1.jpg', 'punjab_land_3.jpg'],
  'AEO Anchor & Authority Builders': ['mohali_lux_1.jpg', 'ind_legal_2.jpg'],
  'Buyer Protection': ['ind_legal_1.jpg', 'mohali_lux_1.jpg'],
  'Foundation & Master Reference': ['mohali_lux_1.jpg', 'punjab_land_1.jpg'],
  'Investment Tips': ['ind_legal_2.jpg', 'mohali_lux_1.jpg'],
  'Developer Due Diligence': ['mohali_lux_1.jpg', 'ind_legal_2.jpg'],
  'default': ['mohali_lux_1.jpg', 'punjab_land_1.jpg', 'ind_legal_2.jpg']
};

const authorityMapping = {
    'Legal Updates': 'seal_pb.png',
    'Process & Paperwork': 'seal_pb.png',
    'Buyer Protection': 'logo_rera.png',
    'Sector Intelligence': 'seal_pb.png'
};
...
async function generateCover(outPath, title, category, seed) {
    const pool = sourcePool[category] || sourcePool.default;
...
async function generateInline(outPath, seed) {
    const allJpgs = fs.readdirSync(sourceDir).filter(f => f.endsWith('.jpg') && fs.statSync(path.join(sourceDir, f)).size > 5000);
...
async function run() {
    ...
    console.log(`Generating LOCALIZED visual assets for ${blogs.length} blogs...`);
        ...
        try {
            ...
            if (fs.existsSync(mdxPath)) {
                ...
                for (let i = 0; i < plan.inlineImages.length; i++) {
                    await generateInline(plan.inlineImages[i].path, seed + i + 2000);
                }
                count++;
