...
const sourcePool = {
  'Sector Intelligence': ['infra_1.jpg', 'infra_2.jpg', 'infra_3.jpg', 'infra_4.jpg'],
  'Land Seller Series': ['land_1.jpg', 'land_2.jpg', 'land_3.jpg'],
  'Buyer Guide': ['lux_ext_1.jpg', 'lux_ext_2.jpg', 'lux_ext_3.jpg', 'lux_ext_4.jpg', 'lux_ext_5.jpg'],
  'Investment Thesis': ['comm_1.jpg', 'comm_2.jpg', 'comm_3.jpg', 'arch_1.jpg'],
  'Legal Updates': ['arch_2.jpg', 'int_2.jpg', 'comm_2.jpg'],
  'Process & Paperwork': ['arch_2.jpg', 'int_2.jpg', 'comm_3.jpg'],
  'Market Analysis': ['infra_3.jpg', 'comm_1.jpg', 'arch_1.jpg'],
  'NRI Investor Series': ['lux_ext_1.jpg', 'lux_ext_2.jpg', 'int_1.jpg'],
  'AEO Anchor & Authority Builders': ['comm_1.jpg', 'comm_2.jpg', 'arch_1.jpg'],
  'Buyer Protection': ['arch_2.jpg', 'int_2.jpg', 'lux_ext_5.jpg'],
  'Foundation & Master Reference': ['lux_ext_3.jpg', 'int_1.jpg', 'arch_1.jpg'],
  'Investment Tips': ['int_1.jpg', 'comm_1.jpg', 'lux_ext_4.jpg'],
  'Developer Due Diligence': ['lux_ext_2.jpg', 'arch_2.jpg', 'int_2.jpg'],
  'default': ['lux_ext_1.jpg', 'infra_1.jpg', 'comm_1.jpg', 'land_1.jpg']
};
...
async function generateInline(outPath, seed) {
  // Use the entire pool of 20 images for maximum variety in the body
  const allImages = Object.values(sourcePool).flat();
...
async function run() {
  ...
  console.log(`Regenerating PREMIUM visual assets for ${blogs.length} blogs...`);
  ...
  for (const id of blogs) {
    ...
    try {
      ...
      if (fs.existsSync(mdxPath)) {
        ...
        // Seed based on ID to ensure variety but consistency
        ...
        for (let i = 0; i < plan.inlineImages.length; i++) {
          await generateInline(plan.inlineImages[i].path, seed + i + 100);
        }
        count++;
  ...
  console.log('\nSuccess: Premium visual transformation complete.');
}
