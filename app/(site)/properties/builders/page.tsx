...
export const metadata: Metadata = {
  title: {
    absolute: "Top Real Estate Builders in Mohali - RERA Verified Developers"
  },
  description: "RERA-verified builders and cooperative housing societies in Mohali — from JLPL and Bestech to Jubilee and GMADA. Prices from ₹45L to ₹9.19Cr.",
  alternates: {
    canonical: "https://www.realtyconsultants.in/properties/builders",
  },
  openGraph: {
    title: "Top Real Estate Builders in Mohali - RERA Verified Developers",
    description: "28 RERA-verified builders and cooperative housing societies in Mohali — from JLPL and Bestech to Jubilee and GMADA. Prices from ₹45L to ₹9.19Cr.",
    url: "https://www.realtyconsultants.in/properties/builders",
    type: "website",
  },
  twitter: {
    card: "summary_large_image",
    title: "Top Real Estate Builders in Mohali - RERA Verified",
