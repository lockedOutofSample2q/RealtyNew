          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-8 lg:gap-12 items-start">
            <div>
              ...
              <div className="flex items-center gap-5 sm:gap-14 flex-wrap py-6 mb-8 border-y border-black/5">
                <div>
                  <p className="text-[10px] uppercase tracking-widest text-black/35 mb-1.5 font-bold">Total Area</p>
                ...
                {property.type && (
                  <div>
                    <p className="text-[10px] uppercase tracking-widest text-black/35 mb-1.5 font-bold">Category</p>
              ...
              {property.nearby_landmarks && property.nearby_landmarks.length > 0 && (
                <section className="mb-16">
                  <h2 className="text-[18px] font-bold text-black mb-6 font-display">Nearby Landmarks</h2>
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    {property.nearby_landmarks.map((lm) => (
                      <div key={lm.name} className="p-4 bg-black/[0.02] border border-black/5 rounded-xl">
                        <p className="text-[11px] text-black/40 font-bold uppercase mb-1">{lm.name}</p>
                        <p className="text-[18px] font-bold text-black font-display">{lm.time} min</p>
                      </div>
                    ))}
                  </div>
                </section>
