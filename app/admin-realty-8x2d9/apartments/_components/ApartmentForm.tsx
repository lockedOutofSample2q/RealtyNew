  ...
  return (
    <form onSubmit={handleSave} className="min-h-screen" style={{ backgroundColor: "#F7F6F3" }}>
      <div className="sticky top-14 z-30 bg-white border-b border-black/[0.06] flex items-center gap-4 -mx-6 -mt-6 px-6 py-3">
        <Link href="/admin-realty-8x2d9/apartments" className="flex items-center gap-1.5 font-body text-sm text-[#888] hover:text-[#0A0A0A] transition-colors">
      ...
      <div className="max-w-6xl w-full mx-auto px-6 flex items-start gap-8 mt-8 pb-12">
        ...
        <div className="flex-1 min-w-0 space-y-6">
          ...
          <div className="flex items-center justify-between py-4">
            <Link href="/admin-realty-8x2d9/apartments" className="font-body text-sm text-[#888] hover:text-[#0A0A0A] transition-colors">
              ← Back to Apartments
            </Link>
            <button type="submit" disabled={saving}
