  ...
  return (
    <div className="bg-white min-h-[70vh] flex items-center justify-center py-20 animate-fade-in">
      <div className="container-site max-w-2xl text-center">
        <div className="w-24 h-24 bg-charcoal/5 rounded-full flex items-center justify-center mx-auto mb-8">
          <svg className="w-12 h-12 text-charcoal" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="mb-10">
          <Button asChild variant="primary" size="lg" className="w-full sm:w-auto bg-charcoal hover:bg-charcoal/90 text-white rounded-full">
