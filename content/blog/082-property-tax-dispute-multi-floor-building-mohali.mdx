...
title: "Resolving Property Tax Disputes in Multi-Floor Buildings: Separate IDs, MOU, and What the Process Looks Like"
slug: "property-tax-dispute-multi-floor-building-mohali"
keyword: "property tax dispute multi floor building mohali resolve"
excerpt: "Property tax dispute resolution in Mohali multi-floor buildings. MOU between floor owners, separate property IDs, electricity transfer, GMADA transfer. The 3-month resolution process."
description: "Property tax dispute resolution in Mohali multi-floor buildings. MOU between floor owners, separate property IDs, electricity transfer, GMADA transfer. The 3-month resolution process."
...
SCHEMA: Article
@type: Article
headline: Resolving Property Tax Disputes in Multi-Floor Buildings: Separate IDs, MOU, and What the Process Looks Like
author: Amritpal Singh
author type: Person
author url: /about
...
main entity of page: /blog/property-tax-dispute-multi-floor-building-mohali

FAQ SCHEMA: Add FAQ schema for every H2/H3 heading phrased as a question
BREADCRUMB: Home > Blog > Disputes & Legal Rights > Resolving Property Tax Disputes in Multi-Floor Buildings: Separate IDs, MOU, and What the Process Looks Like

FAQ SCHEMA ITEMS:
Q: Why do multi-floor buildings in Mohali face property tax deadlocks?
A: When a building is constructed, the Municipal Committee initially generates a single property tax ID for the entire structure. If the original owner sells individual floors without separating this ID, any unpaid back-tax appears as a collective liability for all new floor owners.
Q: What happened in our 3-month property tax case study?
A: A seller had not paid property tax for several years and sold the ground floor. The back-dated tax appeared as a collective liability across all floors, freezing the buyer's GMADA transfer until we intervened.
Q: How do you resolve a shared property tax liability across floors?
A: The permanent resolution is drafting a formal Memorandum of Understanding (MOU) between all floor owners to allocate the historical tax liability, paying the dues, and immediately applying to the Municipal Committee for separate property IDs for each floor.
Q: Why are separate property IDs critical before buying a floor?
A: Without a separate property ID and a No Dues Certificate (NDC) specific to your floor, you cannot legally register the property, complete the GMADA transfer, or eventually resell it without taking on the previous owner's unpaid liabilities.
Q: What goes into a property tax MOU between floor owners?
A: The MOU must specify the exact square footage owned by each party, detail the period of the default, state the exact financial contribution required from each owner, and mandate cooperation for separating the IDs.
Q: How does the GMADA transfer work after a property tax dispute?
A: Once the Municipal Committee clears the tax and separates the IDs, you submit a certified copy of the registry and the required fee to GMADA. The process requires an OTP from the seller, making their ongoing cooperation essential.
Q: What role does the electricity meter play in the transfer process?
A: An independent electricity meter from PSPCL serves as strong proof of independent possession and severs the final shared utility link between floor owners, protecting you if another owner defaults.
Q: What should you check before buying an independent floor in Mohali?
A: You must verify that the floor has a completely separate property tax ID, demand a current No Dues Certificate (NDC), ensure the electricity connection is independent, and confirm the mutation status in the revenue records.
-->
