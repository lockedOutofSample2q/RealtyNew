...
The reason? The previous owner (the seller in this transaction) had defaulted on a series of installments. Because those installments remained unpaid, the builder had exercised their right under the allotment letter to cancel the [booking](/booking) and forfeit a portion of the amount paid. The seller had not disclosed this cancellation to the new buyer, hoping to use the buyer's funds to settle the dues or simply exit the deal before the builder took further action.
...
## Can a Cancelled Plot [booking](/booking) Actually Be Reinstated?
...
If you find yourself in a situation where a project seems to be moving in the wrong direction, it’s vital to understand [what happens to your [booking](/booking) amount if a Mohali project gets stalled or cancelled](/blog/mohali-project-stalled-cancelled-[booking](/booking)-refund). The mechanics of recovery are similar, but the leverage points differ.
...
Months four through six involved the negotiation of the "reinstatement fee." Builders often charge a penalty for resuming a cancelled [booking](/booking). We negotiated this down by showing that the buyer was a victim of the seller's fraud and by committing to an immediate 100% payment of the remaining 35% balance.

## The Resolution: Reallocation to Adjacent Joda Plots

By month seven, we reached a breakthrough. The builder agreed to reinstate the [booking](/booking). However, as mentioned, the original plot numbers were no longer fully available as a pair. The buyer had originally purchased "joda" plots (two adjacent plots intended to be used together).
...
While we resolved this through negotiation, it's important to know your [real estate disputes & legal rights in Punjab 2026](/blog/real-estate-disputes-legal-rights-punjab-2026). Under RERA, a developer cannot arbitrarily cancel a [booking](/booking). They must:
...
If the plot was ever cancelled and then reinstated, ask for the "Reinstatement Letter." Often, builders reinstate [booking](/booking)s but keep certain conditions (like higher EDC or interest) that the seller might not mention.
