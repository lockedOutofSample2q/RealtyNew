---
coverImage: /assets/images/blog/mohali-plot-cancelled-booking-recovery-process.jpg
title: >-
  The 8-Month Plot Recovery: How a Cancelled Booking Was Reinstated and
  Reallocated — A Case Study
slug: mohali-plot-cancelled-booking-recovery-process
keyword: mohali plot cancelled booking recovery process
excerpt: >-
  Anonymised case study: Mohali plots cancelled by builder due to previous owner
  non-payment, client had paid 65%, 8-month recovery, reallocation to adjacent
  joda plot. The persistence that resolved it.
