...
Even in a "clean" transaction, the paperwork is dense. For a [GMADA plot transfer](/blog/gmada-plot-transfer-ownership-process), you need a certified copy of the registry, which must be stamped by the Tehsildar. A [WhatsApp](https://wa.me/917814613916) photo of the deed isn't enough. Many buyers find themselves stuck because the OTP for the online transfer permission goes to the *last* registered owner, who may now be unresponsive.
