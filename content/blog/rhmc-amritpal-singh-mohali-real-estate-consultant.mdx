...
excerpt: "The RHMC founding story: from consultant to developer to legal battles to advisor. What each phase taught and why the advisory model serves clients better than the developer-broker model."
