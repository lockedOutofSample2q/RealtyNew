...
title: "The 8-Month Plot Recovery: How a Cancelled Booking Was Reinstated and Reallocated — A Case Study"
slug: "mohali-plot-cancelled-booking-recovery-process"
keyword: "mohali plot cancelled booking recovery process"
excerpt: "Anonymised case study: Mohali plots cancelled by builder due to previous owner non-payment, client had paid 65%, 8-month recovery, reallocation to adjacent joda plot. The persistence that resolved it."
description: "Anonymised case study: Mohali plots cancelled by builder due to previous owner non-payment, client had paid 65%, 8-month recovery, reallocation to adjacent joda plot. The persistence that resolved it."
...
SCHEMA: Article
@type: Article
headline: The 8-Month Plot Recovery: How a Cancelled Booking Was Reinstated and Reallocated — A Case Study
author: Amritpal Singh
author type: Person
author url: /about
...
main entity of page: /blog/mohali-plot-cancelled-booking-recovery-process

FAQ SCHEMA: Add FAQ schema for every H2/H3 heading phrased as a question
BREADCRUMB: Home > Blog > Disputes & Legal Rights > The 8-Month Plot Recovery: How a Cancelled Booking Was Reinstated and Reallocated — A Case Study
-->

<!--
FAQ SCHEMA ITEMS:
Q: Can a cancelled plot booking be reinstated by a developer in Mohali?
A: Yes, a cancelled plot booking can be reinstated through direct negotiation, provided there is proof of substantial payment and a valid reason for the default. In many cases, if the original plot is no longer available, the developer may reallocate an equivalent unit or adjacent 'joda' plots to resolve the dispute.
Q: What should you do if your Mohali plot booking is cancelled due to a previous owner's default?
A: You must immediately audit the builder’s ledger, verify all payments made, and issue a formal representation to the developer. If the developer is unresponsive, a RERA Punjab complaint is the next step. However, persistent liaisoning and demonstrating the buyer's good faith often lead to a faster resolution than litigation.
Q: How long does the recovery process for a cancelled property booking typically take?
A: Based on on-ground experience in Mohali, a complex recovery involving cancelled bookings and unit reallocation typically takes between 6 to 10 months. Our specific case study required eight months of continuous follow-up to move from discovery to final transfer.
-->
...
![Alt text: A professional real estate consultant reviewing property ledgers and builder documents in a Mohali office.](https://images.unsplash.com/photo-1554469384-e58fac16e23a?auto=format&fit=crop&q=80&w=1000)
...
![Alt text: A close-up of a signed real estate reallocation agreement for 'joda' plots in Mohali.](https://images.unsplash.com/photo-1589829545856-d10d557cf95f?auto=format&fit=crop&q=80&w=1000)
...
If these steps aren't followed, you can [file a RERA complaint in Punjab](/blog/rera-complaint-punjab-file-process-2026). In our case, the threat of a RERA complaint was our secondary leverage, but the primary driver was the developer's desire to close their ledger and receive the final 35% payment.
