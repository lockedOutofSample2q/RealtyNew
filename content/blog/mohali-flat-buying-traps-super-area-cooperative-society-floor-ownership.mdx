...
tags:
  - "Mohali flat buying traps"
  - "super area loading factor"
  - "cooperative society Mohali"
  - "independent floor loan"
schema: |
  {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is the loading factor trap in Mohali flats?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Why are home loans rejected for independent kothi floors in Mohali?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Home loans are frequently rejected because independent floors are registered as undivided shares of a plot rather than individual real estate units. Banks require all owners of the plot (including the ground floor owner) to sign as co-mortgagors, which co-owners rarely agree to do. However, stilt+3/4 floors with separate floor-wise titles registered with GMADA are fully financeable."
        }
      },
      {
        "@type": "Question",
        "name": "What is a transfer file in Mohali cooperative societies?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "A transfer file is an internal society document used to hand over flat ownership when individual land registry is frozen by GMADA due to pending dues or litigation. Purchasing a transfer file under the Punjab Cooperative Societies Act, 1961 means you inherit all outstanding construction penalties and legal liabilities of the previous owner."
        }
      }
    ]
  }
...
<table className="w-full border-collapse border border-gray-200 my-6">
  ...
  <tbody>
    <tr>
      ...
      <td className="border border-gray-200 px-4 py-2">Flat-Level Registry ([GMADA](https://gmada.gov.in/))</td>
...
If the original member owed penalties to the government body for delayed registry completion, that is your problem now. If the society owes [GMADA](https://gmada.gov.in/) penalties for construction violations or over-allotment, every member bears a portion. You will be told the amount is manageable and that others have already paid. Sometimes that is true. Often the final number, when it crystallises, is higher than the figure quoted at the time of purchase.
...
The question to ask before buying in any cooperative society is specific: has the land registry been completed? Not the flat registry. The land registry. If the society has not completed its land registry with [GMADA](https://gmada.gov.in/) or the relevant authority, flat-level registries are not possible regardless of what you are told. For sector-specific verification checklists, see our complete [Tricity Flat Registry Guide](/blog/flat-buyers-guide-tricity-registry-ownership). When evaluating a cooperative housing society's location, cross-reference its popular phase name with the planning grid using our [Mohali Phases Map and Sector Guide](/blog/mohali-phases-map).
...
1. Go to the official [RERA Punjab Public Search Portal](https://rera.punjab.gov.in/).
...
The buyers who come out well are not the ones who paid the least. They are the ones who asked the right questions before the money moved. Before calculating plot areas, plot dimensions, or registry charges, use our free [Punjab Land Area Calculator](/tools/area-calculator) to verify exact square footage and local revenue measurement units across Mohali and Rajpura.
...
The loading factor in Mohali represents the common area added to your flat's actual usable space (carpet area). Builders routinely apply a 35% to 40% loading factor. This means a flat advertised as 1,100 sq.ft. "super area" will yield only about 650 to 700 sq.ft. of carpet area. Under [RERA Punjab](https://rera.punjab.gov.in/), it is illegal to charge a buyer solely on super area.

#### Why are home loans rejected for independent kothi floors in Mohali?
Home loans are frequently rejected because independent floors are registered as undivided shares of a plot rather than individual real estate units. Banks require all owners of the plot (including the ground floor owner) to sign as co-mortgagors, which co-owners rarely agree to do. However, stilt+3/4 floors with separate floor-wise titles registered with [GMADA](https://gmada.gov.in/) are fully financeable.

#### What is a transfer file in Mohali cooperative societies?
A transfer file is an internal society document used to hand over flat ownership when individual land registry is frozen by [GMADA](https://gmada.gov.in/) due to pending dues or litigation. Purchasing a transfer file under the [Punjab Cooperative Societies Act, 1961](https://cooperative.punjab.gov.in/) means you inherit all outstanding construction penalties and legal liabilities of the previous owner.
